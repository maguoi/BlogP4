...
class ChapterManager extends Manager
{
	...
	{
		$db = $this->dbConnect();
		$req = $db->query('SELECT b.id, b.title, b.content, DATE_FORMAT(b.creation_date, GET_FORMAT(DATE, "EUR")) AS creation_date, COUNT(c.id) AS nb_coms FROM chapters AS b LEFT JOIN comments AS c ON c.chapter_id = b.id GROUP BY id ORDER BY b.id');
